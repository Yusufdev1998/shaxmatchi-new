    ...
    <div className="space-y-3">
      <div>
        ...
        <p className="mt-1 text-sm text-slate-600">
          O'qituvchi tomonidan sizga tayinlangan vazifalar darajalari. Keyingi:
          kurs → modul → vazifa → pazllar.
        </p>
      </div>
      ...
      {loading ? (
        ...
        <div className="rounded-xl border border-dashed border-slate-200 bg-slate-50/70 px-4 py-8 text-center text-sm text-slate-600">
          Hali tayinlangan debyutlar yo'q. O'qituvchi pazllarni tayinlaganda,
          ular shu yerda paydo bo'ladi.
        </div>
      ) : (
