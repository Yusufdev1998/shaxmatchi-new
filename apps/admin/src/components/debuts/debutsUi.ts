...
export const debutsUi = {
  ...
  linkBtn: "rounded px-1 py-0.5 text-xs font-medium text-slate-600 hover:bg-slate-100 hover:text-slate-900",
  accentLink: "rounded px-1 py-0.5 text-xs font-medium text-emerald-700 hover:bg-emerald-50 hover:text-emerald-900",
  indigoLink: "rounded px-1 py-0.5 text-xs font-medium text-indigo-600 hover:bg-indigo-50 hover:text-indigo-800",
  dangerBtn: "rounded px-1 py-0.5 text-xs font-medium text-red-600 hover:bg-red-50 hover:text-red-800",
