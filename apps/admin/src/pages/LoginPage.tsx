...
export function LoginPage() {
  ...
  React.useEffect(() => {
    if (reason === "wrong-role") {
      setError("Bu hisob Admin panelga kira olmaydi (faqat o'qituvchi).");
    }
  }, [reason]);
  ...
  async function onSubmit(e: React.FormEvent) {
    ...
    try {
      ...
      if (json.user.type !== "teacher") {
        clearAuthSession();
        throw new Error("Bu hisob Admin panelga kira olmaydi (faqat o'qituvchi).");
      }
    ...
    <div className="mx-auto w-full max-w-md px-4 py-10">
      <div className="rounded-2xl border border-slate-200 bg-white p-5 shadow-sm">
        <div className="space-y-1">
          <h1 className="text-lg font-semibold tracking-tight">Admin kirish</h1>
