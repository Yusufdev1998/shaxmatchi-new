      ...
      <div className={debutsUi.card}>
        ...
        {loading ? (
          ...
          <div className={debutsUi.listRows}>
            {items.map((m) => (
              <div key={m.id} className={[debutsUi.row, debutsUi.rowHover].join(" ")}>
                ...
                <div className="flex shrink-0 flex-wrap items-center justify-end gap-1">
                  <Button
                    ...
                    variant="secondary"
                    disabled={busy}
                    onClick={() => navigate(`/debuts/levels/${levelIdSafe}/courses/${courseIdSafe}/modules/${m.id}/tasks`)}
                  >
                    Vazifalar
                  </Button>
                  <button
                  ...
                  <button type="button" className={debutsUi.dangerBtn} disabled={busy} title="O'chirish" onClick={() => void remove(m.id)}>
